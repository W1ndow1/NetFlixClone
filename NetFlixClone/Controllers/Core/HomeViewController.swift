...
class HomeViewController: UIViewController {
    ...
    let sectionTitles: [String] = ["인기영화", "인기TV", "선호도", "공개예정", "최고평점"]
    ...
    private func configureHeroHeaderView() {
        APICaller.shared.trendingMovies(completion: { result in
            switch result {
...
extension HomeViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case Section.TrendingMovies.rawValue:
            APICaller.shared.trendingMovies{ result in
                switch result {
                case .success(let titles):
        ...
        case Section.Popular.rawValue:
            APICaller.shared.popular{ result in
                switch result {
                case .success(let titles):
                    cell.configure(with: titles)
                case .failure(let error):
        ...
        case Section.TopRated.rawValue:
            APICaller.shared.topRate{ result in
                switch result {
                case .success(let titles):
                    cell.configure(with: titles)
                case .failure(let error):
